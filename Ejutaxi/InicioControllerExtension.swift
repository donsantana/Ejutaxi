    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if tableView.isEqual(self.TablaDirecciones){
            ...
            case "Perfil"?:
                ...
                self.navigationController?.show(vc, sender: nil)
            case "Compartir app"?:
                if let name = URL(string: "itms://itunes.apple.com/us/app/apple-store/id1453640772?mt=8") {
    ...
    func SocketEventos(){
        ...
        if self.appUpdateAvailable(){
            ...
            alertaVersion.addAction(UIAlertAction(title: "Si", style: .default, handler: {alerAction in
                ...
                UIApplication.shared.openURL(URL(string: "itms-apps://itunes.apple.com/us/app/apple-store/id1453640772?mt=8")!)
            }))
